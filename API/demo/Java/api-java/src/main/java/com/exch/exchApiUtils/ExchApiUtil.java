 ...
 * @date: 2019/08/29
 */
public class ExchApiUtil {

    private final static Logger logger = LoggerFactory.getLogger(ExchApiUtil.class);

    public static final String URL_PREFIX = "https://xkd.com/v1/rest/api";//api基础地址
