...
import com.exch.exchApiUtils.MapToObject;
import com.exch.constants.Constant;
import com.exch.constants.ConstantKey;
import com.exch.request.*;
import com.exch.response.*;
 ...
 * @date: 20190906
 */
public class ExchApi {

    private static Logger logger = LoggerFactory.getLogger(ExchApi.class);

    public static void main(String[] args) {
        ExchApi api = new ExchApi();
        ResponseBaseBean<CoinsResponse> a = api.getCoins();
